package com.hdp.order_service.application.handler.cancelorder;
...
public class CancelOrderCommandHandlerImpl implements CancelOrderCommandHandler {
    ...
    private CancelOrderResult.SubOrderResult toSubOrder(SubOrder entity) {
        return new CancelOrderResult.SubOrderResult(
    ...
    private CancelOrderResult.OrderItemResult toItem(OrderItem entity) {
        return new CancelOrderResult.OrderItemResult(
    ...
    private CancelOrderResult.AppliedCouponResult toCoupon(AppliedCoupon entity) {
        return new CancelOrderResult.AppliedCouponResult(
            entity.getId(), null,
