...
public interface CancelOrderUsecase extends Usecase<CancelOrderUsecase.Command, CancelOrderUsecase.Result> {

    record Command(UUID id, UUID cancelledBy, String reason) {}
