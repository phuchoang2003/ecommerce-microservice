...
public interface UpdateSubOrderStatusUsecase extends Usecase<UpdateSubOrderStatusUsecase.Command, UpdateSubOrderStatusUsecase.Result> {

    record Command(UUID id, SubOrderStatus status, UUID changedBy, String reason) {}
