...
public record UpdateOrderStatusResult(
    ...
    List<UpdateOrderStatusResult.SubOrderResult> subOrders,
    List<UpdateOrderStatusResult.OrderItemResult> items,
    List<UpdateOrderStatusResult.AppliedCouponResult> appliedCoupons
) {
