package com.hdp.product_service.application.handler.createproduct;
...
public class CreateProductCommandHandlerImpl implements CreateProductCommandHandler {
    ...
    private CreateProductResult toResult(Product entity) {
